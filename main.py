import argparse
import training_pipe_satellite as training_pipe
...
if __name__=="__main__":
    ...
    parser.add_argument("--dataset", type=str, default="mnist", help='Dataset to use: mnist or eurosat')
...
#epoch: it has run all samples
    ...
    parser.add_argument("--patch_size", type=int, default=8, help='')
